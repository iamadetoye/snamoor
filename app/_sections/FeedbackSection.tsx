    ...
    <section className="py-12 min-h-[550px] h-full" id="feedback">
      <div className="max-container padding-container flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="w-full lg:w-2/5 flex flex-col items-center lg:items-start space-y-4">
          ...
          <p className="regular-16 text-tertiary-text text-center lg:text-start max-w-xl">Lorem Ipsum but also the leap into electronic typesetting, remaining essentially unchanged. Lorem Ipsum but also the leap into electronictype setting, remaining essentially unchanged.</p>
          <div className="">
